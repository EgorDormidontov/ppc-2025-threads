...
namespace dormidontov_e_kannon_all {
...
TEST(dormidontov_e_kannon_all, mat36x36) {
  ...
  dormidontov_e_kannon_all::allTask task_seq(task_data_seq);
...
TEST(dormidontov_e_kannon_all, mat16) {
  boost::mpi::communicator world;
  tbb::global_control global_limit(tbb::global_control::max_allowed_parallelism, 4);
...
TEST(dormidontov_e_kannon_all, wrong_matrix_size) {
  boost::mpi::communicator world;
  tbb::global_control global_limit(tbb::global_control::max_allowed_parallelism, 4);
  matrix A(4 * 4);
  matrix B(3 * 3);
...
TEST(dormidontov_e_kannon_all, mat_36x36) {
  boost::mpi::communicator world;
  tbb::global_control global_limit(tbb::global_control::max_allowed_parallelism, 4);
  size_t test_side_size = 36;
  size_t test_num_blocks = 6;
...
TEST(dormidontov_e_kannon_all, wrong_block_size) {
  boost::mpi::communicator world;
  tbb::global_control global_limit(tbb::global_control::max_allowed_parallelism, 4);
...
TEST(dormidontov_e_kannon_all, mat27x27) {
  boost::mpi::communicator world;
  tbb::global_control global_limit(tbb::global_control::max_allowed_parallelism, 4);
...
TEST(dormidontov_e_kannon_all, I_mat) {
  boost::mpi::communicator world;
  tbb::global_control global_limit(tbb::global_control::max_allowed_parallelism, 4);
  size_t test_side_size = 36;
  size_t test_num_blocks = 6;
